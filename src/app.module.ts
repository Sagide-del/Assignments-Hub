...
@Module({
  ...
  providers: [
    // Order matters: JwtAuthGuard runs first and attaches the full
    // AuthenticatedUser (id, schoolId, role, name, ...) to req.user; RolesGuard
    // and TenantGuard both depend on that being set already.
